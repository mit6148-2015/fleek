...
var fs = require('fs');
var data = JSON.parse(fs.readFileSync('../../scraping/asy_getters/usajmo_probs_asy.json', 'utf8'));
...
function doItFor(index) {
    ...
    Problem.create({
        meta: new problemMeta.usajmo(curdatum.year, curdatum.problem_number),
        source: {
    ...
    if (index < data.length) {
        ...
        mongoose.disconnect();
        console.log('Added ' + index + ' documents for USAJMO.');
    }
