...
angular.module('fleekApp').controller("pageController", function ($scope, $rootScope, $location, AuthService, DataService) {
	...
	$rootScope.restrictedTemplates = ['/views/problem.html','/views/search.html','/views/set.html','/views/setlist.html','/views/profile.html']; //unauthorized users can't see these
