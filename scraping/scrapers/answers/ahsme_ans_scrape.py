...
out_file = open("ahsme_answers.json","w")
...
if __name__ == '__main__':
 	...
 	out_file.write("[\n")
 	while year < 2000:
		ansString = str(year) + "_AHSME_Answer_Key"
		link = 'http://www.artofproblemsolving.com/Wiki/index.php/' + ansString
		ans = readAnswers(ansString)
		data = data = {"contest_name":"AHSME", "name_modifier":"","year":year, "answers":ans, "source_name":"Art of Problem Solving", "source_link": link}
		print(len(ans))
